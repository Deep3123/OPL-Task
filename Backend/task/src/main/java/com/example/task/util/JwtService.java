...
public class JwtService {
	...
	public String generateToken(String userName) {
		...
		return Jwts.builder().setClaims(claims) // ✅ set the entire map of claims
	...
	private Claims extractAllClaims(String token) {
		...
		return Jwts.parserBuilder().setSigningKey(getSignKey()) // ✅ Correct method to set key
				.build().parseClaimsJws(token).getBody(); // ✅ This returns the claims (payload) }
	}
